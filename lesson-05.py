...
# file_obj = open("one_file.txt", "w+")
# #content = input("Введём несколько строчек текста. По окончании сделать пустую строку ")
# content = ("djflasghasfdklsf")
# content = file_obj.write()
#
# file_obj.close()
#
# file_obj = open("one_file.txt")
# content = file_obj.read()
# print(content)
#
# file_obj.close()

file_obj = open("one_file.txt", encoding='utf-8')
#print(file_obj.read())
#content = file_obj.read()
content = "djflasghasfdklsf"
print(content)
